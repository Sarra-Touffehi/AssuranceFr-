...
@Component({
  selector: 'app-liste-souscriptions',
  templateUrl: './liste-souscriptions.component.html',
  styleUrls: ['./liste-souscriptions.component.css']
})
export class ListeSouscriptionsComponent implements OnInit {
